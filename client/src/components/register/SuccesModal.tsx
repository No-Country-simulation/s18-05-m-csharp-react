...
const SuccesModal: FC<Props> = ({ setOpenModal }) => {
  return (
    <div className="fixed bg-white rounded-xl w-[360px] h-[250px] top-1/2 left-1/2 
    ...
    >
      ...
      <div className="flex justify-evenly w-full text-small">
        <button type="button" className="font-bold uppercase text-primary  px-4 py-2 border-2 rounded-xl border-transparent hover:border-primary transition-all ease duration-200">
          Iniciar sesión
        </button>
